...
@Service
public class InvestorInvestmentRoundShowService3 implements AbstractShowService<Investor, InvestmentRound> {
	...
	public InvestmentRound findOne(final Request<InvestmentRound> request) {
		...
		id = request.getModel().getInteger("fundingId");
		aux = this.repository.findOneFundingById(id);
		result = aux.getInvestmentRound();
		return result;
	}
